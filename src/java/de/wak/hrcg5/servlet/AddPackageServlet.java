...
public class AddPackageServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (Packages.addPackage(description, specification, detail, rent, category, products, null)) {
            getServletContext().getRequestDispatcher("/AddPackageSuccess.jsp").forward(request, response);
        }
    }
